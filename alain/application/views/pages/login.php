		...
		<h3 class="title">School Management System</h3>
				<form class="form-horizontal loginForm" action="http://ads1ict.ethdigitalcampus.com/DCWeb/authenticate.do" method="post" style="margin:0px;padding:0px 35px 0px 35px;">
				   <div class="control-group" style="margin-bottom:10px;">
				    <br><h4><label class="control-label" style="margin-bottom:10px;" for="inputEmail">Sign In</label></h4><br>
				    <div class="controls">
				  ...
				  <input type="hidden" name="dbConnVar" value="ADS1"><br><br>
				<button class="btn btn-default btn-md"><b>Sign In </b></button>
				<p><a href="http://ads1ict.ethdigitalcampus.com/DCWeb/form/jsp_sms/ForgotPasswordNew.jsp?mailflag=true&header=true&dbConnVar=ADS1">Forgot password?</a> </p>
