        ...
        <div class="row flow-offset-2">
          ...
          <div class="col-md-4">
            ...
            <ul class="list">
                ...
                <li><?php echo anchor('files/AlDhafra2014-English.pdf', 'ADEC Inspection Report, Published in 2014 ENGLISH', 'target="_blank"'); ?></li>
                <li><?php echo anchor('files/AlDhafra2013-English.pdf', 'ADEC Inspection Report, Published in 2013 ENGLISH', 'target="_blank"'); ?></li>
                <li><?php echo anchor('files/AdvencED-2014-ExternalReviewReport.pdf', 'AdvancED Report', 'target="_blank"'); ?></li>
                <li><?php echo anchor('files/InspectionFollowupNovember2014.pdf', 'Accreditation Certificates', 'target="_blank"'); ?></li>
            </ul>
            <!-- END List -->
          </div>
        </div>
